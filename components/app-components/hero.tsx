      ...
      <div className="relative z-20 w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg sm:text-xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
            Descubre increíbles apartamentos y casas en alquiler en las mejores
            ubicaciones del mundo. Tu nuevo hogar te está esperando.
          </p>
          ...
          <div className="flex flex-col lg:flex-row gap-4 mb-6">
            ...
            <div className="flex-1 relative">
              ...
              <Input
                ...
                className="pl-12 h-14 text-lg rounded-2xl border-gray-200 focus:border-teal-500 focus:ring-teal-500"
              />
            </div>
            ...
            <div className="lg:w-64">
              <Select value={propertyType} onValueChange={setPropertyType}>
                <SelectTrigger
                  aria-label="Property type select button"
                  className="h-14 text-lg rounded-2xl border-gray-200 focus:border-teal-500 focus:ring-teal-500"
                >
            ...
            <Button
              size="lg"
              className="h-14 px-8 bg-gradient-to-r rounded-2xl from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-white font-semibold text-lg hover:shadow-xl transition-all duration-200"

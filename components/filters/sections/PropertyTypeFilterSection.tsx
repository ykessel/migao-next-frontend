...
/**
 * PropertyTypeFilterSection Component Props
 */
...
/**
 * PropertyTypeFilterSection Component
 * 
 * Collapsible section for filtering properties by type.
 * Displays a select dropdown with available property types from the constants.
 * 
 * Follows SRP - Only handles property type filter UI presentation.
 * 
 * @param propertyType - Current property type filter value
 * @param setPropertyType - Function to update property type filter
 * @param open - Whether the collapsible section is open
 * @param setOpen - Function to toggle collapsible section
 */
export function PropertyTypeFilterSection({
    propertyType,
    setPropertyType,
    open,
    setOpen

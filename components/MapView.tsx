// MapView has been moved to MapView.client.tsx for client-side only rendering with Next.js dynamic import.
// Please use MapView.client.tsx and import it dynamically with ssr: false.

...
export default function PropertyCardItemList({
  ...
  return (
    <Card className={`w-full flex rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 ${className}`}>
      {/* Image Section */}
      ...
      <div className="flex flex-col w-full p-4 truncate">
        ...
        <CardContent className="p-0 pt-2 flex-grow grid gap-2">
          <div className="text-xl font-bold text-emerald-600">{formatPrice()} /mes</div>

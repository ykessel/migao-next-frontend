...
function PropertyListClientContent() {
  ...
  const rawParams = useMemo(() => Object.fromEntries(urlSearchParams.entries()), [urlSearchParams]);
  ...
  const handlePageChange = (page: number) => updateUrlParam('page', page.toString());
    ...
    return (
      <div className="text-center py-16">
        <div className="max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-4">No hay propiedades que coincidan con tus criterios de búsqueda. Intenta ajustar los filtros.</p>
        </div>
      </div>
    );
  }
              ...
              <span>
                ...
                <div
                    ...
                    <div className="flex items-center gap-2">
                        <span className="hidden sm:inline text-sm font-medium text-gray-700 mr-2">Vista:</span>
                    ...
                    {/* Sort Options */}
                    <div className="flex items-center gap-2">
                        <span className="hidden sm:inline text-sm font-medium text-gray-700 mr-2">Ordenar por:</span>

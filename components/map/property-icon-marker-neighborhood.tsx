...
const PropertyIconMarkerNeighborhood = () => {
    ...
    return L.divIcon({
        ...
        html: `
            <svg width="40" height="50" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" style="filter: drop-shadow(0 0 12px rgba(13,148,136,0.4)) drop-shadow(0 2px 8px rgba(0,0,0,0.18));">
                <!-- Pin shape (teardrop) -->
                <path d="M256,0C159.969,0,82.109,77.859,82.109,173.906c0,100.719,80.016,163.688,123.297,238.719 C246.813,484.406,246.781,512,256,512s9.188-27.594,50.594-99.375c43.297-75.031,123.297-138,123.297-238.719 C429.891,77.859,352.031,0,256,0z" 
                      fill="${markerColor}" 
                      stroke="white" 
                      stroke-width="2.5"/>
                <!-- White circle background -->
                <circle cx="256" cy="180" r="140" fill="white" stroke="${markerColor}" stroke-width="4"/>
